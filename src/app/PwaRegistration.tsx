...
export function PwaRegistration() {
  useEffect(() => {
    ...
    const reloadOnce = () => {
      ...
      if (window.location.pathname === "/staff/entry" || window.location.pathname.startsWith("/interviews") || window.location.pathname.startsWith('/staff/interviews') || window.location.pathname.startsWith('/staff/interview-materials')) return;
