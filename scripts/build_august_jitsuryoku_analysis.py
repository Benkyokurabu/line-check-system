...
.panel {{ display:none; background:var(--panel); border:1px solid var(--line); border-top:0; padding:12px; overflow-x:auto; overflow-y:visible; }} .panel.active {{ display:block; }} .panel-toolbar {{ position:sticky; top:var(--panel-toolbar-top); z-index:30; background:var(--panel); border-bottom:1px solid var(--line); padding:0 0 8px; margin:0 0 10px; }} h2 {{ font-size:16px; margin:0 0 8px; }} .note {{ color:var(--muted); margin:0 0 10px; }}
